...
export namespace rental {
    ...
    namespace v1 {
        ...
        /** Properties of a LocationStaus. */
        interface ILocationStaus {

            /** LocationStaus location */
            location?: (rental.v1.ILocation|null);

            /** LocationStaus feeCent */
            feeCent?: (number|null);

            /** LocationStaus kmDriven */
            kmDriven?: (number|null);

            /** LocationStaus poiName */
            poiName?: (string|null);

            /** LocationStaus timestampSec */
            timestampSec?: (number|null);
        }

        /** Represents a LocationStaus. */
        class LocationStaus implements ILocationStaus {

            /**
             * Constructs a new LocationStaus.
             * @param [properties] Properties to set
             */
            constructor(properties?: rental.v1.ILocationStaus);
            ...
            /**
             * Creates a LocationStaus message from a plain object. Also converts values to their respective internal types.
             * @param object Plain object
             * @returns LocationStaus
             */
            public static fromObject(object: { [k: string]: any }): rental.v1.LocationStaus;

            /**
             * Creates a plain object from a LocationStaus message. Also converts values to other types if specified.
             * @param message LocationStaus
             * @param [options] Conversion options
             * @returns Plain object
             */
            public static toObject(message: rental.v1.LocationStaus, options?: $protobuf.IConversionOptions): { [k: string]: any };

            /**
             * Converts this LocationStaus to JSON.
             * @returns JSON object
             */
            public toJSON(): { [k: string]: any };
        }
        ...
        interface ITrip {
            ...
            /** Trip start */
            start?: (rental.v1.ILocationStaus|null);

            /** Trip current */
            current?: (rental.v1.ILocationStaus|null);

            /** Trip end */
            end?: (rental.v1.ILocationStaus|null);
        ...
        class Trip implements ITrip {
            ...
            /** Trip start. */
            public start?: (rental.v1.ILocationStaus|null);

            /** Trip current. */
            public current?: (rental.v1.ILocationStaus|null);

            /** Trip end. */
            public end?: (rental.v1.ILocationStaus|null);
        ...
        /** Properties of a GetProfilePhotoRsponse. */
        interface IGetProfilePhotoRsponse {

            /** GetProfilePhotoRsponse url */
            url?: (string|null);
        }

        /** Represents a GetProfilePhotoRsponse. */
        class GetProfilePhotoRsponse implements IGetProfilePhotoRsponse {

            /**
             * Constructs a new GetProfilePhotoRsponse.
             * @param [properties] Properties to set
             */
            constructor(properties?: rental.v1.IGetProfilePhotoRsponse);

            /** GetProfilePhotoRsponse url. */
            public url: string;

            /**
             * Creates a GetProfilePhotoRsponse message from a plain object. Also converts values to their respective internal types.
             * @param object Plain object
             * @returns GetProfilePhotoRsponse
             */
            public static fromObject(object: { [k: string]: any }): rental.v1.GetProfilePhotoRsponse;

            /**
             * Creates a plain object from a GetProfilePhotoRsponse message. Also converts values to other types if specified.
             * @param message GetProfilePhotoRsponse
             * @param [options] Conversion options
             * @returns Plain object
             */
            public static toObject(message: rental.v1.GetProfilePhotoRsponse, options?: $protobuf.IConversionOptions): { [k: string]: any };

            /**
             * Converts this GetProfilePhotoRsponse to JSON.
             * @returns JSON object
             */
            public toJSON(): { [k: string]: any };
        }
        ...
        class ProfileService extends $protobuf.rpc.Service {
             ...
             * @param callback Node-style callback called with the error, if any, and GetProfilePhotoRsponse
             */
             ...
             * @returns Promise
             */
            public getProfilePhoto(request: rental.v1.IGetProfilePhotoRequest): Promise<rental.v1.GetProfilePhotoRsponse>;
        ...
        namespace ProfileService {
             ...
             * @param error Error, if any
             * @param [response] GetProfilePhotoRsponse
             */
            type GetProfilePhotoCallback = (error: (Error|null), response?: rental.v1.GetProfilePhotoRsponse) => void;
